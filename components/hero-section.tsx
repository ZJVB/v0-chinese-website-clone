...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`hidden lg:flex absolute top-1/2 right-8 -translate-y-1/2 z-10 transition-all duration-500 ${
          currentBanner.id === 4 
      ...
      >
        <Image
          ...
          width={600}
          height={300}
          className="object-contain drop-shadow-2xl w-auto h-auto rounded-lg"
        />
      </div>
