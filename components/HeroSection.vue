  ...
  >
    ...
    >
      ...
      <div 
        ...
        :class="banner.id === 4 
          ? 'from-[#041653]/70 via-[#041653]/40 to-transparent' 
          : 'from-[#041653]/90 via-[#041653]/70 to-[#041653]/30'"
      />
    </div>
      ...
      <div class="pt-16 max-w-2xl">
        ...
        <div class="flex flex-wrap gap-4">
          <UButton
            ...
            size="lg"
            class="bg-blue-700 text-white hover:bg-blue-800 gap-2 rounded-md px-7 py-5 text-base font-semibold"
          >
